...
def parse_args():
  ...
  parser.add_argument('--exciter',nargs=4,metavar=('UID','X','Y','Z'), required=False,
  ...
  parser.add_argument('--print',type=str,
                      help="Arguments; actions,objects")
  
  parser.add_argument('--action',nargs=3, metavar=('tx','rx','protocol'),
                      help="An action that will be simulated")
  parser.add_argument('--default',nargs=2,metavar=('name','value'),
...
def main():
  ...
  if args.tag is not None or args.exciter is not None:      # Creates or move a tag/exciter
    obj_args = None
    model = None
